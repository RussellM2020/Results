...
class PointImageEnv(Env):
    ...
    def observation_space(self):
        return Box(low =-self.mid + 1, high = self.mid - 1, shape=(2,))
    ...
    def reset(self):
        ...
        observation = self._state#TODO: Get image here
        return observation
    ...
    def step(self, action):
        ...
        next_observation = self._state
        return Step(observation=next_observation, reward=-dist, done=done, dist = -dist)
