...
def pendulum_last2(seed = 0, numBatches = 500000, gamma=0.97, animate=False, min_timesteps_per_batch=2500, initial_stepsize=1e-3):
    ...
    numTimestepsBatch = min_timesteps_per_batch
