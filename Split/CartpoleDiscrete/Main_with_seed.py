...
for seed in range(0,100,20):
    Rewards1,_,_= cartpoleSplit_1(seed = seed, numBatches = batches,logdir=None,vf_type='linear', animate=False)
    last1History.append(Rewards4)

    Rewards2,_,_= cartpoleSplit_2(seed = seed, numBatches = batches,logdir=None,vf_type='linear', animate=False)
    last2History.append(Rewards4)

    Rewards3,_,_= cartpoleSplit_3(seed = seed, numBatches = batches,logdir=None,vf_type='linear', animate=False)
    last3History.append(Rewards4)
